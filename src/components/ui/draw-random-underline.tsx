...
// NOTE: DrawSVGPlugin is a premium GSAP plugin that requires a Club GreenSock membership
// For production use, you'll need to purchase a GSAP membership or use an alternative animation approach
// Visit https://greensock.com/club/ for membership information
