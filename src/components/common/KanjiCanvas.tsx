  ...
  useEffect(() => {
    ...
    const setup = () => {
      ...
      const animate = () => {
        ...
        if (allSettled && settledFrame === null) settledFrame = frame;
        frame = (frame + 1) % 65536;

        // Stop after 120 drift frames once all particles have settled
        if (settledFrame !== null && ((frame - settledFrame + 65536) % 65536) > 120) return;
